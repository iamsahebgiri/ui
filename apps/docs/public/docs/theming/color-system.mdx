...
```tsx showLineNumbers
import type { ColorScale } from "@sahebg/ui";
...
If you want to use one of the Wedges Color Palette colors, `wedgesPalette` can be imported from `@sahebg/ui`, for example:
